    ...
    <div className="max-w-4xl space-y-10">
      ...
      <section>
        ...
        {favorites.length === 0 ? (
          ...
          <p className="text-sm text-gray-400 text-center py-6">Inga favorit-leverantörer börjar på <strong>{favLetter}</strong></p>
        ) : (
        ...
        {searching ? (
          ...
          <>
            ...
            {searchResults.length === 0 ? (
              ...
              <p className="text-sm text-gray-400 text-center py-6">Inga leverantörer börjar på <strong>{searchLetter}</strong></p>
            ) : (
              <div className="grid gap-4 sm:grid-cols-2">
